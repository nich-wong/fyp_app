...
<div class="row ">
    ...
    <div class="row text-start mx-0 py-2 justify-content-start ">
        
        <div class="col-2 h5 text-center">{{$order->order_id}}</div>

        @switch($status)
        @case("pending")
            <div class="col-5 h5 my-0 text-danger">PENDING</div>
            @break
        
        @case("preparing")
            <div class="col-5 h5 my-0 text-warning">PREPARING</div>
            @break
     
        @case("ready")
            <div class="col-5 h5 my-0 text-success">READY</div>    
            @break
    
        @case("served")
            <div class="col-5 h5 my-0 text-primary">SERVED</div>
            @break
        
        @case("cancelled")
            <div class="col-5 h5 my-0 text-danger">CANCELLED</div>
            @break
    
        @default
            <div class="col-5 my-0">Currently Unavailable</div>
        @endswitch


        @switch($status_payment)
        @case("true")
            <div class="col-5 h5 my-0 text-primary">PAID</div> 
            @break
        @default
            <div class="col-5 h5 my-0 text-danger">NOT PAID</div>
        @endswitch
